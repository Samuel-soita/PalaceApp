        ...
        $allModels: {
            ...
            delete: function (_a) {
                return __awaiter(this, arguments, void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                        if (model && SOFT_DELETABLE_MODELS.includes(model)) {
                            modelProp = model.charAt(0).toLowerCase() + model.slice(1);
                            return [2 /*return*/, basePrisma[modelProp].update(__assign(__assign({}, args), { data: { deletedAt: new Date() } }))];
                        }
                        return [2 /*return*/, query(args)];
                    });
                });
                ...
                return __awaiter(this, arguments, void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                        if (model && SOFT_DELETABLE_MODELS.includes(model)) {
                            ...
                            return [2 /*return*/, basePrisma[modelProp].updateMany(__assign(__assign({}, args), { data: { deletedAt: new Date() } }))];
                        }
                        return [2 /*return*/, query(args)];
                    });
                });
