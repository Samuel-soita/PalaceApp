...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, PermissionCode[]> = {
    ...
    SECRETARY: ['VIEW_GLOBAL_STATS', 'VIEW_PERSONNEL', 'MANAGE_APPOINTMENTS'],
    SYSTEM_ADMIN: ['VIEW_GLOBAL_STATS', 'VIEW_FINANCIALS', 'MANAGE_DEPARTMENTS', 'MANAGE_USERS', 'VIEW_PERSONNEL', 'CREATE_ANNOUNCEMENTS_GLOBAL'],
